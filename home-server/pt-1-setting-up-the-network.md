...
Check out the next post to configure access to the server: [Configuring Zero Trust Access to your Server](/home-server/pt-2-configuring-zero-trust-access.md)
